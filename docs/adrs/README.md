...
| # | Decision | Status |
|---|----------|--------|
| [0001](0001-build-motson-in-go.md) | Build Motson in Go | Accepted |
| [0002](0002-store-matches-in-neondb-postgres.md) | Store matches in NeonDB Postgres | Accepted |
| [0003](0003-use-football-data-org-as-fixture-provider.md) | Use football-data.org as the fixture provider | Accepted |
| [0004](0004-single-service-with-in-process-sync-ticker.md) | Single service with in-process sync ticker | Accepted |
| [0005](0005-lean-library-stack-on-the-standard-library.md) | Lean library stack on the standard library | Accepted |
